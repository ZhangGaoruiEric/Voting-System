...
namespace VotingSystem
{
    public partial class Topic : Form
    {
        ...
        private void showDataGrid()
        {
            ...
            //select the information from Topic table
        ...
        private void Topic_GD_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Reason_textBox1.Text = Topic_GD.CurrentRow.Cells[12].Value.ToString();
            Reason_textBox2.Text = Topic_GD.CurrentRow.Cells[13].Value.ToString();
            Reason_textBox3.Text = Topic_GD.CurrentRow.Cells[14].Value.ToString();
            Reason_textBox4.Text = Topic_GD.CurrentRow.Cells[15].Value.ToString();

            showCountDown(Topic_GD.CurrentRow.Cells[16].Value.ToString(), Topic_GD.CurrentRow.Cells[6].Value.ToString());
        }
        ...
        private void showCountDown(String previousTimeString, String deadline)
        {
            ...
            //set a deadline funtion to counting down the rest of the time
        }
        ...
        private void update_Load(object sender, EventArgs e)
        {
            ...
            this.Topic_GD.Columns[12].Width = 80;
            this.Topic_GD.Columns[13].Width = 80;
            this.Topic_GD.Columns[14].Width = 80;
            this.Topic_GD.Columns[15].Width = 80;
        ...
        private void Home_btn_Click(object sender, EventArgs e)
        {
            ...
            //Switch to the other AccountType Login
        }
